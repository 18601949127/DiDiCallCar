 ...
 */
public class TabPager10 extends BaseCallCarTabPager {
    ...
    public TabPager10(Context context, CallCarPagerBean.DataBean.ChildrenBean childrenData) {
        super(context);
    ...
    public View initView() {
        View view = View.inflate(context, R.layout.callcartab_10,null);
