 ...
 */
public class ShunfengcheTabPager extends BaseCallCarTabPager {

    private final CallCarPagerBean.DataBean.ChildrenBean childrenData;
    private TextView textView;

    public ShunfengcheTabPager(Context context, CallCarPagerBean.DataBean.ChildrenBean childrenData) {
        super(context);
