 ...
 */
public class TabPager11 extends BaseCallCarTabPager {
    ...
    public TabPager11(Context context, CallCarPagerBean.DataBean.ChildrenBean childrenData) {
        super(context);
    ...
    public View initView() {
        View view = View.inflate(context, R.layout.callcartab_11,null);
