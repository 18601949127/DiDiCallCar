 ...
 */
public class TabPager8 extends BaseCallCarTabPager {
    ...
    public TabPager8(Context context, CallCarPagerBean.DataBean.ChildrenBean childrenData) {
        super(context);
    ...
    public View initView() {
        View view = View.inflate(context, R.layout.callcartab_8,null);
