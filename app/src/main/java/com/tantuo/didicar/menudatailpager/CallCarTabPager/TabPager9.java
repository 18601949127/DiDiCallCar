 ...
 */
public class TabPager9 extends BaseCallCarTabPager {
    ...
    public TabPager9(Context context, CallCarPagerBean.DataBean.ChildrenBean childrenData) {
        super(context);
    ...
    public View initView() {
        View view = View.inflate(context, R.layout.callcartab_9,null);
