...
public class TabFragment10 extends BaseFragment implements
    ...
    public View initView() {
        ...
        rootview = View.inflate(getActivity(), R.layout.callcar_tab_fragment_10, null);
...
//        mBaiduMap = mMapView.getMap();
    ...
    private void initSearchLocation() {
        ...
        destin_text_view.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                LogUtil.i("进入类:TabFragment10, 方法:onTextChanged() destin_text_view ");
    ...
    public void onGetPoiResult(PoiResult result) {
        if (result == null || result.error == SearchResult.ERRORNO.RESULT_NOT_FOUND) {
            LogUtil.i("进入类:TabFragment10, 方法:onGetPoiResult() 未找到结果 ");
    ...
    public void initData() {
        ...
        LogUtil.i("进入类:" + gettitle() + "TabFragment10, 方法:initData()  ");
        super.initData();
