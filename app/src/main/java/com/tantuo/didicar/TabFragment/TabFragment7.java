...
public class TabFragment7 extends BaseFragment implements
    ...
    public TabFragment7(String title, String contents) {
        super();
        this.title = title;
    ...
    public View initView() {
        ...
        rootview = View.inflate(getActivity(), R.layout.callcar_tab_fragment_7, null);
...
//        mBaiduMap = mMapView.getMap();
    ...
    private void initSearchLocation() {
        ...
        destin_text_view.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                LogUtil.i("进入类:TabFragment7, 方法:onTextChanged() destin_text_view ");
    ...
    public void onGetPoiResult(PoiResult result) {
        if (result == null || result.error == SearchResult.ERRORNO.RESULT_NOT_FOUND) {
            LogUtil.i("进入类:TabFragment7, 方法:onGetPoiResult() 未找到结果 ");
    ...
    public void initData() {
        ...
        LogUtil.i("进入类:" + gettitle() + "TabFragment7, 方法:initData()  ");
        super.initData();
